...
- Added `isLoading` method of `Apollo` decorator to receive a loading state of a query that is extracted from the Redux store directly [Issue #36](https://github.com/apollostack/angular2-apollo/issues/36)
